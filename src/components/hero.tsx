...
function Content() {
  return (
    <div className="z-10 flex flex-col items-center justify-center h-auto max-w-full max-h-full pt-16 space-y-8 transition-all w-fit lg:pt-20 md:h-full">
      {/* Heading */}
      ...
      {/* Subtitle */}
      <div className="w-full px-4 space-y-4 text-center md:opacity-0 sm:px-0 md:max-h-0 md:animate-fade-in--body">
