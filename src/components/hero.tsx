...
export default function Hero() {
  return (
    <div
      className="flex flex-col justify-center items-center overflow-clip pt-16 w-full h-[100vh] bg-hero-radial-md text-center drop-shadow-2xl -space-y-8 md:space-y-0 md:flex-row md:-space-x-12"
    >
