...
export default function Page() {
  return (
    <section className="flex flex-col overflow-x-clip items-center justify-between w-full">
      <article className="flex flex-col items-center justify-between h-full w-full pt-16">
        <div
